...
export const routes: Routes = [
  { path: '', redirectTo: 'home', pathMatch: 'full' },
  {
    ...
    children: [
      ...
      { path: 'forgetPassword', loadComponent:()=>import("./pages/forgetpassword/forgetpassword").then((c)=>c.Forgetpassword), title: 'Address' },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'allorders', loadComponent:()=>import("./pages/allorders/allorders").then((c)=>c.Allorders), title: 'Address' },
